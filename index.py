...
Label (win, text = "Please Login Here", font = ('Condensed', 20), fg = "red", bg = "yellow",relief= RAISED, width= 30 ).place (x= 110, y = 50)

Label (win, text = "Enter User Id", font = ('Condensed', 20), fg = "red", bg = "yellow",relief= RAISED, width= 15  ).place (x= 120, y = 150)
uid = Entry (win, font = ('Condensed', 18), bg="brown", fg= "white", width= 15	)
uid.place(x= 380, y = 150)

Label (win, text = "Select Dept/ Branch", font = ('Condensed', 20), fg = "red", bg = "yellow", relief= RAISED, width= 15 ).place (x= 120, y = 250)
menu = StringVar()
drop = OptionMenu (win,menu, "BCA", "BSc.ITM", "BSc. CS", "EEE", "EE", "ME", "Civil")
drop.place(x= 450, y = 250)

Label (win, text = "Enter Password", font = ('Condensed', 20), fg = "red", bg = "yellow",relief= RAISED, width= 15 ).place (x= 120, y = 350, )
